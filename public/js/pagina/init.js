    ...
    $('#form-registrar').submit(function(e) {
        ...
        $.ajax(form.attr('action'), {
            ...
            error: function(jsXhr) {
                $(".btn-primary", this).prop('disabled', false);
                //r = JSON.parse(jsXhr.responseJSON);
                r = jsXhr.responseJSON;
                if (r.error == 2) {
                    bootbox.confirm({
                        //size: "small",
                ...
                $(".btn-primary", form).prop('disabled', false);
            }
        });
    });
